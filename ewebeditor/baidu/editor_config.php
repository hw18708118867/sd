...
(function () {
	...
	URL = "<?php echo $URL;?>";
    UEDITOR_CONFIG = {
        imagePath:"<?php echo "$webdb[www_url]/$webdb[updir]/other/";?>", //URL + "server/upload/"图片文件夹所在的路径，用于显示时修正后台返回的图片url！具体图片保存路径需要在后台设置。！important
        ...
        filePath: "<?php echo "$webdb[www_url]/$webdb[updir]/other/";?>",  //附件文件夹保存路径 URL + "server/upload/"
	    catchRemoteImageEnable:false,                                   //是否开启远程图片抓取
        catcherUrl:URL +"server/submit/php/getRemoteImage.php",             //处理远程图片抓取的地址
        localDomain:"<?php echo $HOST;?>",                                        //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地
        ...
        toolbars:[
            ['FullScreen', 'Source', '|', 'Undo', 'Redo', '|',
                ...
                'Link', 'Unlink', 'Anchor', '|', 'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|', 'InsertImage', 'Emotion', 'InsertVideo', 'Attachment', 'Map', 'GMap',  'PageBreak',  '|',
        ...
        snapscreenServerFile:  "<?php echo $PATH;?>/ewebeditor/baidu/server/upload/php/snapImgUp.php", //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
