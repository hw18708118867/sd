...

{
	...
	$pay99_view[$webdb[pay99_view]]=' checked ';

	$alipay_view[$webdb[alipay_view]]=' checked ';

	$tenpay_view[$webdb[tenpay_view]]=' checked ';

	$yeepay_view[$webdb[yeepay_view]]=' checked ';
	
	$paypal_view[$webdb[paypal_view]]=' checked ';
