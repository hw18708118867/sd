...
elseif($job=='clean')
{
	...
	if(!$step){
		require("head.php");
		echo "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"TableWord mt10\"><tr><td class=\"tips\">你确实要清空收件箱吗？<span class='red'>不可恢复！</span></td></tr><tr><td><div class=\"td_btn\"><p><A HREF='?job=$job&step=2' class=\"botton sure\">确认</A><A HREF='?job=list' class=\"botton cancel\">取消</A><p></div></td></tr></table>";
		exit;
	}
	$db->query($SQL);
